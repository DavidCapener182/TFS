...
export function IncidentMobileCard({ incident, referenceLabel }: IncidentMobileCardProps) {
  ...
  return (
    <Card className="relative p-3 hover:shadow-sm transition-shadow border-slate-200">
      <div className="flex flex-col gap-2.5">
        ...
        <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-50 mt-0.5">
