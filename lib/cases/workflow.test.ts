...
function buildCase(overrides: Partial<QueueCaseRecord> = {}): QueueCaseRecord {
  return {
    ...
    originTargetTable: overrides.originTargetTable || 'tfs_incidents',
    originTargetId: overrides.originTargetId || 'incident-1',
    originIncidentSummary: overrides.originIncidentSummary || 'Store portal theft logged.',
    originIncidentDescription: overrides.originIncidentDescription || 'Store reported stolen fragrance.',
    originTheftValueGbp: overrides.originTheftValueGbp ?? 120,
    originTheftItemsSummary: overrides.originTheftItemsSummary || 'Dior Sauvage x1',
