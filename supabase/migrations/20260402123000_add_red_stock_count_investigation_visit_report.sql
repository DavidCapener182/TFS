...
as $$
  select case activity_key
    ...
    when 'red_stock_count_investigation' then array[
      'activityReference', 'timeWindowInScope', 'storeArea', 'evidenceReference',
      'lpObjective', 'peoplePresent', 'recordsReviewed',
      'redCountContext', 'staffRolesQuestioned', 'deliveryChecksCompleted', 'stockControlQuestionsAsked',
      'externalTheftExposureChecked',
      'caseConfidence', 'lossValueImpact', 'rootCauseOrWeakness',
      'staffExplanationSummary', 'deliveryFindings', 'internalTheftIndicators', 'externalTheftIndicators',
      'processGapIndicators', 'likelyCauseType', 'likelyCauseRationale',
      'outcomeStatus', 'followUpOwner', 'followUpDeadline', 'followUpStatus', 'followUpCompletedAt',
      'immediateContainment', 'escalatedTo', 'recountsOrFurtherChecks', 'controlsOrCoachingIssued',
...
begin
  ...
  if activity_key in ('completed_line_checks', 'red_stock_count_investigation') then
