...
exports.STORE_VISIT_ACTIVITY_OPTIONS = exports.RED_STOCK_COUNT_LIKELY_CAUSE_OPTIONS = exports.STORE_VISIT_ACTIVITY_FOLLOW_UP_STATUS_OPTIONS = exports.STORE_VISIT_ACTIVITY_CONFIDENCE_OPTIONS = exports.STORE_VISIT_ACTIVITY_OUTCOME_STATUS_OPTIONS = exports.STORE_VISIT_TYPE_OPTIONS = void 0;
exports.isStoreVisitActivityKey = isStoreVisitActivityKey;
exports.getStoreVisitActivityOption = getStoreVisitActivityOption;
exports.getStoreVisitActivityFieldDefinitions = getStoreVisitActivityFieldDefinitions;
exports.getStoreVisitActivityFieldDefinition = getStoreVisitActivityFieldDefinition;
exports.formatStoreVisitActivityFieldValue = formatStoreVisitActivityFieldValue;
exports.getStoreVisitActivitySectionGuide = getStoreVisitActivitySectionGuide;
exports.getStoreVisitActivityCountedItemsGuide = getStoreVisitActivityCountedItemsGuide;
exports.getStoreVisitActivityAmountChecksGuide = getStoreVisitActivityAmountChecksGuide;
exports.getStoreVisitActivityFieldSection = getStoreVisitActivityFieldSection;
exports.validateStoreVisitActivityPayloadCompleteness = validateStoreVisitActivityPayloadCompleteness;
exports.normalizeStoreVisitActivityDetails = normalizeStoreVisitActivityDetails;
exports.normalizeStoreVisitActivityPayloads = normalizeStoreVisitActivityPayloads;
exports.formatStoreVisitCurrency = formatStoreVisitCurrency;
exports.getStoreVisitCountedItemDelta = getStoreVisitCountedItemDelta;
exports.getStoreVisitCountedItemVarianceValue = getStoreVisitCountedItemVarianceValue;
exports.buildStoreVisitCountedItemVarianceNote = buildStoreVisitCountedItemVarianceNote;
exports.buildStoreVisitActivityDetailText = buildStoreVisitActivityDetailText;
exports.getStoreVisitTypeLabel = getStoreVisitTypeLabel;
exports.getStoreVisitActivityLabel = getStoreVisitActivityLabel;
exports.getStoreVisitNeedLevelLabel = getStoreVisitNeedLevelLabel;
exports.computeStoreVisitNeed = computeStoreVisitNeed;
exports.STORE_VISIT_TYPE_OPTIONS = [
    {
        value: 'action_led',
...
const COMMON_ACTIVITY_CONTEXT_FIELDS = [
    {
        key: 'lpObjective',
...
const COMMON_ACTIVITY_FINDINGS_FIELDS = [
    {
        key: 'lossValueImpact',
...
const COMMON_ACTIVITY_ACTION_FIELDS = [
    {
...
exports.STORE_VISIT_ACTIVITY_OUTCOME_STATUS_OPTIONS = [
...
exports.STORE_VISIT_ACTIVITY_CONFIDENCE_OPTIONS = [
...
exports.STORE_VISIT_ACTIVITY_FOLLOW_UP_STATUS_OPTIONS = [
    { value: 'not_started', label: 'Not started' },
    { value: 'in_progress', label: 'In progress' },
    { value: 'complete', label: 'Complete' },
    { value: 'cancelled', label: 'Cancelled' },
];
exports.RED_STOCK_COUNT_LIKELY_CAUSE_OPTIONS = [
...
const ACTIVITY_SCOPE_CORE_FIELDS = [
    {
...
const ACTIVITY_FINDINGS_CORE_FIELDS = [
    {
        key: 'caseConfidence',
        ...
        section: 'findings',
        required: true,
        options: exports.STORE_VISIT_ACTIVITY_CONFIDENCE_OPTIONS,
        helperText: 'Required core field for every activity.',
...
const ACTIVITY_ACTION_CORE_FIELDS = [
    {
        key: 'outcomeStatus',
        ...
        section: 'actions',
        required: true,
        options: exports.STORE_VISIT_ACTIVITY_OUTCOME_STATUS_OPTIONS,
        helperText: 'Required core field for every activity.',
    ...
    },
    {
        ...
        section: 'actions',
        required: true,
        options: exports.STORE_VISIT_ACTIVITY_FOLLOW_UP_STATUS_OPTIONS,
        helperText: 'Required core field for every activity.',
...
const ACTIVITY_EVIDENCE_CHAIN_FIELDS = [
    {
...
const INTERNAL_THEFT_FACTUAL_NOTE = 'Record material wording verbatim where it matters, separate fact from inference, and avoid opinion.';
function getActivityFieldDefinition(fields, key) {
...
function withFieldGuidance(field, guidance) {
    return {
        ...field,
        ...guidance,
    };
}
const INTERNAL_THEFT_SECTION_GUIDES = {
    what_checked: {
...
const INTERNAL_THEFT_COUNTED_ITEMS_GUIDE = {
...
const INTERNAL_THEFT_AMOUNT_CHECKS_GUIDE = {
...
const INTERNAL_THEFT_CCTV_SECTION_GUIDES = {
    what_checked: {
...
const INTERNAL_THEFT_CCTV_COUNTED_ITEMS_GUIDE = {
...
const INTERNAL_THEFT_CCTV_AMOUNT_CHECKS_GUIDE = {
...
const STAFF_THEFT_INTERVIEW_PLAN_SECTION_GUIDES = {
    what_checked: {
        title: 'Interview Opening Script',
        intro: 'Use this while opening a Loss Prevention interview with a TFS staff member about suspected theft, setting the tone, and introducing the allegation and evidence.',
        prompts: [
    ...
    actions: {
        ...
        intro: 'Use this before ending the meeting so the close, evidence review, escalation, and pending outcome are documented clearly.',
        prompts: [
...
const RED_STOCK_COUNT_INVESTIGATION_SECTION_GUIDES = {
    what_checked: {
        title: 'Red Stock Count Review Script',
        intro: 'Use this while opening a red stock-count visit, questioning staff, reviewing deliveries, and checking the priority fragrance lines.',
        prompts: [
    ...
    findings: {
        ...
        intro: 'Use this section to compare what staff said against the delivery review, stock line results, and store-floor exposure so the likely cause is clear.',
        prompts: [
    ...
    actions: {
        ...
        intro: 'Use this before closing the visit so immediate controls, recounts, coaching, and escalation are all documented clearly.',
        prompts: [
...
const RED_STOCK_COUNT_INVESTIGATION_COUNTED_ITEMS_GUIDE = {
    title: 'Red Count Fragrance Prompts',
    intro: 'Use the live fragrance search to select the high-variance lines, capture the system and counted positions, and test what is driving the loss.',
    prompts: [
...
exports.STORE_VISIT_ACTIVITY_OPTIONS = [
    {
        key: 'checked_banking',
    ...
    },
    {
        ...
        description: 'Specialist interview template for suspected employee cash or stock theft, including evidence prompts, cash discrepancies, and fragrance line checks.',
        detailPlaceholder: 'Capture who was interviewed, the allegation explored, the evidence discussed, and what was admitted, denied, or contradicted.',
    ...
    },
    {
        ...
        description: 'Specialist CCTV-confirmed internal theft template for cases already evidenced on footage, with linked stock and cash checks.',
        detailPlaceholder: 'Capture what CCTV confirmed, who was identified, the stock or cash loss evidenced, and the case outcome or escalation.',
        formVariant: 'internal-theft',
    ...
    },
    {
        ...
        description: 'Specialist interview-plan template for Loss Prevention officers interviewing TFS staff about suspected theft, with a full script for each interview stage.',
        detailPlaceholder: 'Capture the theft interview plan, the evidence discussed, and the staff member responses from opening through close.',
        ...
        fields: [
            withFieldGuidance(getActivityFieldDefinition(COMMON_ACTIVITY_CONTEXT_FIELDS, 'lpObjective'), {
                ...
                captureHint: 'Record the theft concern, why Loss Prevention is holding the interview, and what the meeting needs to establish.',
            }),
            withFieldGuidance(getActivityFieldDefinition(COMMON_ACTIVITY_CONTEXT_FIELDS, 'peoplePresent'), {
                scriptLines: [
                    '"For the record, confirm everyone present for this interview and the role each person holds."',
                ],
                captureHint: 'List the interviewer, note taker, witness, representative, manager, or any other attendee present during the meeting.',
            }),
            withFieldGuidance(getActivityFieldDefinition(COMMON_ACTIVITY_CONTEXT_FIELDS, 'recordsReviewed'), {
                scriptLines: [
                    '"The evidence and records reviewed for this interview include..."',
                ],
                captureHint: 'Record the CCTV, stock records, till records, witness material, or other documents reviewed before or during the interview.',
            }),
            {
                key: 'caseReference',
                ...
                captureHint: 'Enter the main case, incident, HR, or ER reference attached to the interview plan.',
            },
            {
                key: 'subjectProfile',
                ...
                captureHint: 'Record the subject\'s full name, job title, and service length exactly as confirmed at the start of the meeting.',
            },
            {
                ...
                captureHint: 'Record the interview location and whether it took place in the store office, another room, or another formal setting.',
            },
            {
                ...
                captureHint: 'Record the evidence available at the point the interview started, including the key allegation-supporting material.',
            },
            {
                ...
                captureHint: 'Summarise how the introduction and formalities were covered at the start of the meeting.',
            },
            {
                key: 'toneSetting',
                ...
                captureHint: 'Record how the fair-process explanation and investigation context were set out to the subject.',
            },
            {
                ...
                captureHint: 'Summarise the subject\'s account of their role and their understanding of the relevant company policies.',
            },
            {
                key: 'policyAwareness',
                ...
                captureHint: 'Record the subject\'s policy-awareness answer and whether they acknowledged the expected theft / misconduct position.',
            },
            {
                ...
                captureHint: 'Record exactly how the allegation was introduced, keeping it neutral and non-specific at the outset.',
            },
            {
                ...
                captureHint: 'Summarise how the evidence was presented and the subject\'s immediate explanation of what it showed.',
            },
            {
                ...
                captureHint: 'Record the direct answers given when the theft allegation was put plainly and the subject was asked to explain.',
            },
            {
                ...
                captureHint: 'Summarise what was said about any previous or wider incidents while keeping the notes factual and non-leading.',
            },
            {
                ...
                captureHint: 'Record how the meeting was summarised, whether the subject added anything further, and what next-step explanation was given.',
            },
            {
                ...
                captureHint: 'Record the post-interview action plan exactly, including the evidence review, escalation route, and pending outcome stage.',
            },
            withFieldGuidance(getActivityFieldDefinition(COMMON_ACTIVITY_ACTION_FIELDS, 'escalatedTo'), {
                scriptLines: [
                    '"This case is being escalated to the appropriate Regional Director and any other agreed stakeholders."',
                ],
                captureHint: 'Record the Regional Director, HR/ER lead, and any other stakeholder updated immediately after the interview.',
            }),
        ],
    ...
    },
    {
        ...
        description: 'Investigates red stock-count results by questioning staff, reviewing deliveries, and line-checking fragrances to assess internal theft, external theft, or lack of process.',
        detailPlaceholder: 'Capture the red stock-count concern, the delivery and staff checks completed, the fragrance lines reviewed, and the likely cause assessment.',
        formVariant: 'line-check',
        ...
        fields: [
            {
                ...
                captureHint: 'Record the red result, time period, variance value or percentage, and why the store required this investigation visit.',
            },
            {
                ...
                captureHint: 'List the staff members, managers, or keyholders questioned and why they were relevant to the stock-loss enquiry.',
            },
            {
                ...
                captureHint: 'Record the delivery review completed, including paperwork, shortages, damages, claims, transfers, and any gaps found in the process.',
            },
            {
                ...
                captureHint: 'Record the stock-control questions put to staff so the report shows how the process was tested during the visit.',
            },
            {
                ...
                captureHint: 'Record the shop-floor and security controls reviewed to test whether external theft is a likely driver of the red result.',
            },
            {
                ...
                captureHint: 'Summarise the explanation given by the team for the red result, using their wording where it matters.',
            },
            {
                ...
                captureHint: 'Record the key findings from the delivery and paperwork review, including whether shortages or process gaps were evidenced.',
            },
            {
                ...
                captureHint: 'List the indicators that make internal theft a possible or likely cause of the red result.',
            },
            {
                ...
                captureHint: 'List the indicators that make external theft a possible or likely cause of the red result.',
            },
            {
                ...
                captureHint: 'List the indicators that suggest the red result is being driven by weak process rather than theft alone.',
            },
            {
                key: 'likelyCauseType',
                ...
                input: 'select',
                section: 'findings',
                options: exports.RED_STOCK_COUNT_LIKELY_CAUSE_OPTIONS,
                scriptLines: [
                ...
                captureHint: 'Select the most likely overall cause based on the visit findings so far.',
            },
            {
                ...
                captureHint: 'Summarise the reasoning behind the likely-cause assessment, linking it to the staff questioning, delivery checks, and line-check results.',
            },
            {
                ...
                captureHint: 'Record the additional checks or investigation work still required after the visit.',
            },
            {
                ...
                captureHint: 'Record the immediate process corrections, controls, or coaching delivered during the visit.',
            },
            {
                ...
                captureHint: 'Record the escalation route and the next stage of the investigation or process follow-up.',
            },
        ],
...
const STORE_VISIT_ACTIVITY_KEYS_WITH_EVIDENCE_CHAIN = new Set([
...
const STORE_VISIT_ACTIVITY_CORE_WHAT_CHECKED_FIELDS = [
    ...ACTIVITY_SCOPE_CORE_FIELDS,
    ...COMMON_ACTIVITY_CONTEXT_FIELDS,
];
const STORE_VISIT_ACTIVITY_CORE_FINDINGS_FIELDS = [
    ...ACTIVITY_FINDINGS_CORE_FIELDS,
    ...COMMON_ACTIVITY_FINDINGS_FIELDS,
];
const STORE_VISIT_ACTIVITY_CORE_ACTION_FIELDS = [
...
const STORE_VISIT_ACTIVITY_EVIDENCE_FIELD_KEYS = new Set(ACTIVITY_EVIDENCE_CHAIN_FIELDS.map((field) => field.key));
...
const LEGACY_ACTIVITY_FIELD_ALIASES = {
    followUpOwnerDeadline: 'followUpOwner',
};
function dedupeActivityFields(fields) {
    const seen = new Set();
...
function getTemplateSpecificActivityFields(option, section) {
    return (option?.fields || []).filter((field) => {
        if ((field.section || section) !== section)
            return false;
        if (STORE_VISIT_ACTIVITY_CORE_FIELD_KEYS.has(field.key))
            return false;
        if (STORE_VISIT_ACTIVITY_EVIDENCE_FIELD_KEYS.has(field.key))
            return false;
        if (field.key === 'followUpOwnerDeadline')
            return false;
        return true;
    });
}
function composeActivityFields(activityKey, option) {
    const actionFields = [
        ...STORE_VISIT_ACTIVITY_CORE_ACTION_FIELDS,
...
function getStoreVisitActivityFieldOptionLabelFromDefinition(field, value) {
    return field.options?.find((option) => option.value === value)?.label;
}
const STORE_VISIT_ACTIVITY_SECTION_GUIDES = {
    checked_banking: {
        what_checked: {
...
const STORE_VISIT_ACTIVITY_FIELD_GUIDANCE = {
    checked_banking: {
        bankingReference: {
...
const STORE_VISIT_ACTIVITY_COUNTED_ITEMS_GUIDES = {
    completed_line_checks: {
...
const STORE_VISIT_ACTIVITY_AMOUNT_CHECKS_GUIDES = {
    checked_banking: {
...
const STORE_VISIT_ACTIVITY_KEY_SET = new Set(exports.STORE_VISIT_ACTIVITY_OPTIONS.map((option) => option.key));
function isStoreVisitActivityKey(value) {
    return STORE_VISIT_ACTIVITY_KEY_SET.has(value);
}
function getStoreVisitActivityOption(activityKey) {
    return exports.STORE_VISIT_ACTIVITY_OPTIONS.find((option) => option.key === activityKey);
}
function getStoreVisitActivityFieldDefinitions(activityKey) {
...
function getStoreVisitActivityFieldDefinition(activityKey, fieldKey) {
    return getStoreVisitActivityFieldDefinitions(activityKey).find((field) => field.key === fieldKey);
}
function formatStoreVisitActivityFieldValue(activityKey, fieldKey, value) {
...
function getStoreVisitActivitySectionGuide(activityKey, section) {
    return (getStoreVisitActivityOption(activityKey)?.sectionGuides?.[section] ||
        STORE_VISIT_ACTIVITY_SECTION_GUIDES[activityKey]?.[section]);
}
function getStoreVisitActivityCountedItemsGuide(activityKey) {
    return (getStoreVisitActivityOption(activityKey)?.countedItemsGuide ||
        STORE_VISIT_ACTIVITY_COUNTED_ITEMS_GUIDES[activityKey]);
}
function getStoreVisitActivityAmountChecksGuide(activityKey) {
    return (getStoreVisitActivityOption(activityKey)?.amountChecksGuide ||
        STORE_VISIT_ACTIVITY_AMOUNT_CHECKS_GUIDES[activityKey]);
}
function getStoreVisitActivityFieldSection(activityKey, field) {
    if (field.section)
        return field.section;
    const option = getStoreVisitActivityOption(activityKey);
    const legacyEntry = Object.entries(option?.legacyFieldMap || {}).find(([, mappedField]) => mappedField === field.key)?.[0];
    if (legacyEntry === 'findings')
        return 'findings';
    if (legacyEntry === 'actionsTaken' || legacyEntry === 'nextSteps')
        return 'actions';
    if (legacyEntry === 'summary' ||
        legacyEntry === 'peopleInvolved' ||
        legacyEntry === 'reference') {
        return 'what_checked';
    }
    const normalizedKey = field.key.toLowerCase();
    if (normalizedKey.includes('issue') ||
    ...
    if (normalizedKey.includes('action') ||
...
function validateStoreVisitActivityPayloadCompleteness(selectedKeys, payloads) {
    const normalizedPayloads = normalizeStoreVisitActivityPayloads(payloads, selectedKeys);
    return selectedKeys.reduce((issues, activityKey) => {
...
function normalizeStoreVisitActivityDetails(input, selectedKeys) {
    if (!input || typeof input !== 'object' || Array.isArray(input))
        return {};
    const allowedKeys = new Set(selectedKeys && selectedKeys.length > 0 ? selectedKeys : exports.STORE_VISIT_ACTIVITY_OPTIONS.map((option) => option.key));
    const details = {};
    for (const [rawKey, rawValue] of Object.entries(input)) {
        if (!isStoreVisitActivityKey(rawKey) || !allowedKeys.has(rawKey))
            continue;
...
function normalizeStoreVisitTextFields(input, allowedFieldKeys) {
    if (!input || typeof input !== 'object' || Array.isArray(input))
        return {};
    const allowedFieldKeySet = allowedFieldKeys && allowedFieldKeys.length > 0 ? new Set(allowedFieldKeys) : null;
    return Object.entries(input).reduce((fields, [key, rawValue]) => {
...
function appendLegacyFieldValue(fields, fieldKey, value) {
    if (!value)
        return;
    if (!fields[fieldKey]) {
...
function normalizeLegacyStoreVisitFields(activityKey, rawPayload) {
    const option = getStoreVisitActivityOption(activityKey);
    const fieldDefinitions = option?.fields || [];
    if (fieldDefinitions.length === 0)
        return {};
    const allowedFieldKeys = new Set(fieldDefinitions.map((field) => field.key));
    const legacyFieldMap = option?.legacyFieldMap || {};
    const fields = {};
    for (const [legacyKey, fieldKey] of Object.entries(legacyFieldMap)) {
        if (!fieldKey || !allowedFieldKeys.has(fieldKey))
            continue;
        appendLegacyFieldValue(fields, fieldKey, normalizeOptionalText(rawPayload[legacyKey]));
    }
    return fields;
}
function normalizeStoreVisitCountedItems(input) {
    ...
    return input
        ...
        if (!rawItem || typeof rawItem !== 'object' || Array.isArray(rawItem))
            return null;
        const item = {
            productId: normalizeOptionalText(rawItem.productId),
            productLabel: normalizeOptionalText(rawItem.productLabel),
            variantLabel: normalizeOptionalText(rawItem.variantLabel),
            sizeLabel: normalizeOptionalText(rawItem.sizeLabel),
            unitPrice: normalizeOptionalAmount(rawItem.unitPrice),
            systemQuantity: normalizeOptionalInteger(rawItem.systemQuantity),
            countedQuantity: normalizeOptionalInteger(rawItem.countedQuantity),
            notes: normalizeOptionalText(rawItem.notes),
        };
        if (!item.productId &&
            !item.productLabel &&
            !item.variantLabel &&
...
function normalizeStoreVisitAmountChecks(input) {
    if (!Array.isArray(input))
        return [];
    return input
        .map((rawItem) => {
        if (!rawItem || typeof rawItem !== 'object' || Array.isArray(rawItem))
            return null;
        const item = {
            label: normalizeOptionalText(rawItem.label),
            systemAmount: normalizeOptionalAmount(rawItem.systemAmount),
            countedAmount: normalizeOptionalAmount(rawItem.countedAmount),
            amountMatches: normalizeOptionalBoolean(rawItem.amountMatches),
            notes: normalizeOptionalText(rawItem.notes),
        };
        if (!item.label &&
...
function normalizeStoreVisitActivityPayload(activityKey, input) {
    if (!input || typeof input !== 'object' || Array.isArray(input))
        return null;
    ...
    if (amountConfirmed !== null)
        payload.amountConfirmed = amountConfirmed;
    if (itemsChecked.length > 0)
        payload.itemsChecked = itemsChecked;
    if (amountChecks.length > 0)
        payload.amountChecks = amountChecks;
    return Object.keys(payload).length > 0 ? payload : null;
}
function normalizeStoreVisitActivityPayloads(input, selectedKeys) {
    if (!input || typeof input !== 'object' || Array.isArray(input))
        return {};
    const allowedKeys = new Set(selectedKeys && selectedKeys.length > 0 ? selectedKeys : exports.STORE_VISIT_ACTIVITY_OPTIONS.map((option) => option.key));
    const payloads = {};
...
function formatStoreVisitCurrency(value) {
...
function getStoreVisitCountedItemDelta(item) {
    if (typeof item.systemQuantity !== 'number' ||
...
function getStoreVisitCountedItemVarianceValue(item) {
...
function buildStoreVisitCountedItemVarianceNote(item) {
    const delta = getStoreVisitCountedItemDelta(item);
    if (!delta)
        return undefined;
    ...
    const priceLabel = typeof item.unitPrice === 'number' && !Number.isNaN(item.unitPrice)
        ? ` at ${formatStoreVisitCurrency(item.unitPrice)} each`
        : '';
    return `Variance: ${directionLabel}${totalLabel}${priceLabel}.`;
}
function buildStoreVisitActivityDetailText(key, detail, payload) {
    ...
    const detailFieldKeys = option?.detailFieldKeys ||
    ...
    if (normalizedPayload.itemsChecked?.length) {
        ...
        summaryBits.push(`${normalizedPayload.itemsChecked.length} item check${normalizedPayload.itemsChecked.length === 1 ? '' : 's'} recorded${varianceCount > 0 ? `, ${varianceCount} variance${varianceCount === 1 ? '' : 's'} found` : ''}`);
    ...
    if (normalizedPayload.amountChecks?.length) {
        ...
        summaryBits.push(`${normalizedPayload.amountChecks.length} cash check${normalizedPayload.amountChecks.length === 1 ? '' : 's'} recorded${mismatchCount > 0 ? `, ${mismatchCount} mismatch${mismatchCount === 1 ? '' : 'es'} found` : ''}`);
    }
    if (normalizedPayload.amountConfirmed !== null &&
        normalizedPayload.amountConfirmed !== undefined &&
        (option?.formVariant === 'cash-check' || option?.formVariant === 'internal-theft')) {
        summaryBits.push(normalizedPayload.amountConfirmed ? 'Correct amount confirmed' : 'Amount discrepancy found');
    }
...
function getActionPriorityBonus(priority) {
...
function getIncidentSeverityBonus(severity) {
...
function findHighestRule(text, rules) {
...
function getStoreVisitTypeLabel(value) {
    return exports.STORE_VISIT_TYPE_OPTIONS.find((option) => option.value === value)?.label || 'Visit';
}
function getStoreVisitActivityLabel(value) {
    return exports.STORE_VISIT_ACTIVITY_OPTIONS.find((option) => option.key === value)?.label || value;
}
function getStoreVisitNeedLevelLabel(level) {
    if (level === 'urgent')
        return 'Urgent';
    if (level === 'needed')
        return 'Visit Needed';
...
function computeStoreVisitNeed({ actions, incidents, lastVisitAt, nextPlannedVisitDate, now = new Date(), }) {
    const referenceDate = parseDate(now) || new Date();
    const positiveDrivers = [];
    const mitigationDrivers = [];
    ...
    if (score >= 70)
        ...
        level = 'monitor';
    const reasons = Array.from(new Set(positiveDrivers
        .sort((a, b) => b.points - a.points)
        .map((driver) => driver.label))).slice(0, 3);
    return {
        score,
        level,
...
function normalizedPriorityLabel(priority) {
    const normalized = String(priority || '').trim().toLowerCase();
    if (normalized === 'urgent')
        return 'Urgent action is open';
    if (normalized === 'high')
        return 'High-priority action is open';
    if (normalized === 'medium')
        return 'Medium-priority action is open';
    return 'Open action is active';
}
function normalizedSeverityLabel(severity) {
    const normalized = String(severity || '').trim().toLowerCase();
    if (normalized === 'critical')
        return 'Critical incident severity is active';
    if (normalized === 'high')
        return 'High-severity incident is active';
    if (normalized === 'medium')
        return 'Medium-severity incident is active';
